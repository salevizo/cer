...
query="SELECT  st_x(st_centroid(geom)) as st_x ,st_y(st_centroid(geom)) as st_y, geom FROM natura2000.spatialfeatures LIMIT 2;"
...
sf = shp.Reader("Natura2000_end2015.shp")
...
m.plot(xx,yy,marker='o',markersize=5, markerfacecolor='red', linewidth=0)
